                ...
                Scaffold(
                    ...
                    NavHost(navController = navController, startDestination = Screens.Home.route){
                        ...
                        composable(route = Screens.Grades.route) {
                            GradeScreen(innerPadding = innerPadding)
                        }
